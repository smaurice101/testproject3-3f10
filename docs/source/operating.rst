[testproject3-3f10] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [testproject3-3f10] container is NOT running**.

.. tip::
   You must have your [testproject3-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=41151  \-\-env VIPERVIZPORT=55549  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:55549/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:55549/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/testproject3-3f10-amd64 (https://hub.docker.com/r/maadsdocker/testproject3-3f10-amd64)
...
.. important::
   docker run -d -p 37081:37081 -p 46599:46599 -p 49981:49981 \-\-env TSS=0 \-\-env SOLUTIONNAME=testproject3-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_dag-testproject3-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=37081  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=46599  \-\-env SOLUTIONVIPERVIZPORT=49981 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=41151 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=55549 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/testproject3-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=49981
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=37081
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/testproject3-3f10-amd64
...
It can be accessed by entering: http://localhost:46599
...
.. important::
   http://localhost:49981/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:49981/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:49981/<html file>
...
[testproject3-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/testproject3-3f10
...
.. important::
   https://testproject3-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_dag-testproject3-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=37081, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39399, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=45557, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=33385, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45873, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45159, HPDEHOST=127.0.1.1, HPDEPORT=46851, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35279

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-9699-testproject3-3f10,solution_preprocessing_dag-testproject3-3f10, python-preprocess-1094-testproject3-3f10,solution_preprocessing_dag-testproject3-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
